...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['redos_match']['runtime_ns'] >= 338440 or time_and_memory['redos_match']['runtime_ns'] <= 352620 or time_and_memory['not_redos_match']['runtime_ns'] >= 338440 or (time_and_memory['not_redos_match']['runtime_ns'] <= 352620))
    return all(results)
