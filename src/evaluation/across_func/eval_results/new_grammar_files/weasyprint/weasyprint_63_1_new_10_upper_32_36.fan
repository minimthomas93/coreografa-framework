...
<body_content> ::= <header_tag> <paragraph_tag> <link_tag> <para_text> {32,36} <img_tag>*
...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 908561100 or time_and_memory['weasyprint_64']['runtime_ns'] <= 1720414200 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 908561100 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 1720414200))
    return all(results)
