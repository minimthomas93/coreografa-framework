...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 198254500 or time_and_memory['weasyprint_64']['runtime_ns'] <= 446138200 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 198254500 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 446138200))
    return all(results)
