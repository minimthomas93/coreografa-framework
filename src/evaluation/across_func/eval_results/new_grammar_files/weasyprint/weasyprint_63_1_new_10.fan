...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['memory_peak'] >= 711890 or time_and_memory['weasyprint_64']['memory_peak'] <= 959108 or time_and_memory['weasyprint_63_1']['memory_peak'] >= 711890 or (time_and_memory['weasyprint_63_1']['memory_peak'] <= 959108))
    return all(results)
...
where count_para_text(<start>) <= 26.0
