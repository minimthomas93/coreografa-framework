...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['memory_peak'] >= 2544533 or time_and_memory['weasyprint_64']['memory_peak'] <= 2690290 or time_and_memory['weasyprint_63_1']['memory_peak'] >= 2544533 or (time_and_memory['weasyprint_63_1']['memory_peak'] <= 2690290))
    return all(results)
