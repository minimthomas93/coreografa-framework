...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 209178200 or time_and_memory['weasyprint_64']['runtime_ns'] <= 397640100 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 209178200 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 397640100))
    return all(results)
