...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['memory_peak'] >= 2851794 or time_and_memory['weasyprint_64']['memory_peak'] <= 2986076 or time_and_memory['weasyprint_63_1']['memory_peak'] >= 2851794 or (time_and_memory['weasyprint_63_1']['memory_peak'] <= 2986076))
    return all(results)
