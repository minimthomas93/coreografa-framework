...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 750876300 or time_and_memory['weasyprint_64']['runtime_ns'] <= 4634446600 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 750876300 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 4634446600))
    return all(results)
