...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['memory_peak'] >= 464574 or time_and_memory['weasyprint_64']['memory_peak'] <= 618121 or time_and_memory['weasyprint_63_1']['memory_peak'] >= 464574 or (time_and_memory['weasyprint_63_1']['memory_peak'] <= 618121))
    return all(results)
