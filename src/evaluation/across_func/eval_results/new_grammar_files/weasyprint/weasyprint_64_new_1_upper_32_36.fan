...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['memory_peak'] >= 2852029 or time_and_memory['weasyprint_64']['memory_peak'] <= 2987692 or time_and_memory['weasyprint_63_1']['memory_peak'] >= 2852029 or (time_and_memory['weasyprint_63_1']['memory_peak'] <= 2987692))
    return all(results)
