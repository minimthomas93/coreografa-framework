...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 268271600 or time_and_memory['weasyprint_64']['runtime_ns'] <= 2120107900 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 268271600 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 2120107900))
    return all(results)
