...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 1417212020 or time_and_memory['weasyprint_64']['runtime_ns'] <= 1876816960 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 1417212020 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 1876816960))
    return all(results)
