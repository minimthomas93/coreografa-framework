...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 821997900 or time_and_memory['weasyprint_64']['runtime_ns'] <= 1841625600 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 821997900 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 1841625600))
    return all(results)
