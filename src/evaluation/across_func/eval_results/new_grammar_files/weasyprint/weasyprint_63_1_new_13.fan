...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 1053893400 or time_and_memory['weasyprint_64']['runtime_ns'] <= 1256166480 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 1053893400 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 1256166480))
    return all(results)
