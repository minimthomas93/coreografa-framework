...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 68217300 or time_and_memory['weasyprint_64']['runtime_ns'] <= 321581400 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 68217300 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 321581400))
    return all(results)
