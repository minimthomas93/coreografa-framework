...
<body_content> ::= <header_tag> <paragraph_tag> <link_tag> <para_text> {41,45} <img_tag>*
...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 195264900 or time_and_memory['weasyprint_64']['runtime_ns'] <= 386595600 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 195264900 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 386595600))
    return all(results)
