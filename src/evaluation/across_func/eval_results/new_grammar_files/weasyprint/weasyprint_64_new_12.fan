...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['memory_peak'] >= 221028 or time_and_memory['weasyprint_64']['memory_peak'] <= 467811 or time_and_memory['weasyprint_63_1']['memory_peak'] >= 221028 or (time_and_memory['weasyprint_63_1']['memory_peak'] <= 467811))
    return all(results)
...
where count_para_text(<start>) <= 41.0
