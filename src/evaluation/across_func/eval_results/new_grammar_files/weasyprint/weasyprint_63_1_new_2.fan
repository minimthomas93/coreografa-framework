...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 1862985720 or time_and_memory['weasyprint_64']['runtime_ns'] <= 2065258800 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 1862985720 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 2065258800))
    return all(results)
