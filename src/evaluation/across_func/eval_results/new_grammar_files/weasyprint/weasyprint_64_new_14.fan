...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 3715236720 or time_and_memory['weasyprint_64']['runtime_ns'] <= 4174841660 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 3715236720 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 4174841660))
    return all(results)
...
where count_para_text(<start>) >= 38.0
where count_para_text(<start>) <= 38.0
