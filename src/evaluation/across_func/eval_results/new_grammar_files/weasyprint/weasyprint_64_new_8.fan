...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['memory_peak'] >= 961378 or time_and_memory['weasyprint_64']['memory_peak'] <= 1208162 or time_and_memory['weasyprint_63_1']['memory_peak'] >= 961378 or (time_and_memory['weasyprint_63_1']['memory_peak'] <= 1208162))
    return all(results)
