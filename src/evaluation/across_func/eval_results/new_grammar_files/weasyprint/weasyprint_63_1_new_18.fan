...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['weasyprint_64']['runtime_ns'] >= 1458439560 or time_and_memory['weasyprint_64']['runtime_ns'] <= 1660712640 or time_and_memory['weasyprint_63_1']['runtime_ns'] >= 1458439560 or (time_and_memory['weasyprint_63_1']['runtime_ns'] <= 1660712640))
    return all(results)
