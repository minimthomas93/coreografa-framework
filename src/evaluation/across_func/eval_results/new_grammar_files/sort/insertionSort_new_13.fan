...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 95780 or time_and_memory['quicksort']['runtime_ns'] <= 125540 or time_and_memory['bubble_sort']['runtime_ns'] >= 95780 or (time_and_memory['bubble_sort']['runtime_ns'] <= 125540) or (time_and_memory['insertionSort']['runtime_ns'] >= 95780) or (time_and_memory['insertionSort']['runtime_ns'] <= 125540))
    return all(results)
