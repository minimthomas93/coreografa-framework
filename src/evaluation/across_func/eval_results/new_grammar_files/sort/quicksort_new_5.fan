...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 73100 or time_and_memory['quicksort']['runtime_ns'] <= 583100 or time_and_memory['bubble_sort']['runtime_ns'] >= 73100 or (time_and_memory['bubble_sort']['runtime_ns'] <= 583100) or (time_and_memory['insertionSort']['runtime_ns'] >= 73100) or (time_and_memory['insertionSort']['runtime_ns'] <= 583100))
    return all(results)
