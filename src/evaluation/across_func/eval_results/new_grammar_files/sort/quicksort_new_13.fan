...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['memory_peak'] >= 1823 or time_and_memory['quicksort']['memory_peak'] <= 2016 or time_and_memory['bubble_sort']['memory_peak'] >= 1823 or (time_and_memory['bubble_sort']['memory_peak'] <= 2016) or (time_and_memory['insertionSort']['memory_peak'] >= 1823) or (time_and_memory['insertionSort']['memory_peak'] <= 2016))
    return all(results)
...
where sortedness(<start>) <= 0.6666666666666666
