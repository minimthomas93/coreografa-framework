...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 11100 or time_and_memory['quicksort']['runtime_ns'] <= 187500 or time_and_memory['bubble_sort']['runtime_ns'] >= 11100 or (time_and_memory['bubble_sort']['runtime_ns'] <= 187500) or (time_and_memory['insertionSort']['runtime_ns'] >= 11100) or (time_and_memory['insertionSort']['runtime_ns'] <= 187500))
    return all(results)
