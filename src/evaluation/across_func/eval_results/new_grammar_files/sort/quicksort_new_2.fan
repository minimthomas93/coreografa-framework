...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 1099050 or time_and_memory['quicksort']['runtime_ns'] <= 1316920 or time_and_memory['bubble_sort']['runtime_ns'] >= 1099050 or (time_and_memory['bubble_sort']['runtime_ns'] <= 1316920) or (time_and_memory['insertionSort']['runtime_ns'] >= 1099050) or (time_and_memory['insertionSort']['runtime_ns'] <= 1316920))
    return all(results)
...
where sortedness(<start>) >= 0.47058823529411764
where sortedness(<start>) <= 0.47058823529411764
