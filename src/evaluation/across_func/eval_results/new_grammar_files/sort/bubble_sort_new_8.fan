...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['memory_peak'] >= 144 or time_and_memory['quicksort']['memory_peak'] <= 144 or time_and_memory['bubble_sort']['memory_peak'] >= 144 or (time_and_memory['bubble_sort']['memory_peak'] <= 144) or (time_and_memory['insertionSort']['memory_peak'] >= 144) or (time_and_memory['insertionSort']['memory_peak'] <= 144))
    return all(results)
