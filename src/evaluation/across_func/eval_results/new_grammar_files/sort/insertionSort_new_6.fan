...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 185060 or time_and_memory['quicksort']['runtime_ns'] <= 214820 or time_and_memory['bubble_sort']['runtime_ns'] >= 185060 or (time_and_memory['bubble_sort']['runtime_ns'] <= 214820) or (time_and_memory['insertionSort']['runtime_ns'] >= 185060) or (time_and_memory['insertionSort']['runtime_ns'] <= 214820))
    return all(results)
