...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 310780 or time_and_memory['quicksort']['runtime_ns'] <= 348190 or time_and_memory['bubble_sort']['runtime_ns'] >= 310780 or (time_and_memory['bubble_sort']['runtime_ns'] <= 348190) or (time_and_memory['insertionSort']['runtime_ns'] >= 310780) or (time_and_memory['insertionSort']['runtime_ns'] <= 348190))
    return all(results)
...
where sortedness(<start>) >= 0.4117647058823529
where sortedness(<start>) <= 0.5294117647058824
