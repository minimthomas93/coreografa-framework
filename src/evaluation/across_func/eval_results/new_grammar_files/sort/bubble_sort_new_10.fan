...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 273370 or time_and_memory['quicksort']['runtime_ns'] <= 310780 or time_and_memory['bubble_sort']['runtime_ns'] >= 273370 or (time_and_memory['bubble_sort']['runtime_ns'] <= 310780) or (time_and_memory['insertionSort']['runtime_ns'] >= 273370) or (time_and_memory['insertionSort']['runtime_ns'] <= 310780))
    return all(results)
...
where sortedness(<start>) >= 0.35294117647058826
where sortedness(<start>) <= 0.7647058823529411
