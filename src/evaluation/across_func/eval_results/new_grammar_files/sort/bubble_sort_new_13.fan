...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 348190 or time_and_memory['quicksort']['runtime_ns'] <= 385600 or time_and_memory['bubble_sort']['runtime_ns'] >= 348190 or (time_and_memory['bubble_sort']['runtime_ns'] <= 385600) or (time_and_memory['insertionSort']['runtime_ns'] >= 348190) or (time_and_memory['insertionSort']['runtime_ns'] <= 385600))
    return all(results)
...
where sortedness(<start>) >= 0.5
where sortedness(<start>) <= 0.5789473684210527
