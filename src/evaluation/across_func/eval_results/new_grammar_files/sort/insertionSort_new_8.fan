...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 274340 or time_and_memory['quicksort']['runtime_ns'] <= 304100 or time_and_memory['bubble_sort']['runtime_ns'] >= 274340 or (time_and_memory['bubble_sort']['runtime_ns'] <= 304100) or (time_and_memory['insertionSort']['runtime_ns'] >= 274340) or (time_and_memory['insertionSort']['runtime_ns'] <= 304100))
    return all(results)
...
where sortedness(<start>) >= 0.631578947368421
where sortedness(<start>) <= 0.631578947368421
