...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 1316920 or time_and_memory['quicksort']['runtime_ns'] <= 1534790 or time_and_memory['bubble_sort']['runtime_ns'] >= 1316920 or (time_and_memory['bubble_sort']['runtime_ns'] <= 1534790) or (time_and_memory['insertionSort']['runtime_ns'] >= 1316920) or (time_and_memory['insertionSort']['runtime_ns'] <= 1534790))
    return all(results)
