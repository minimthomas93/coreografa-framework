...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['quicksort']['runtime_ns'] >= 9700 or time_and_memory['quicksort']['runtime_ns'] <= 686300 or time_and_memory['bubble_sort']['runtime_ns'] >= 9700 or (time_and_memory['bubble_sort']['runtime_ns'] <= 686300) or (time_and_memory['insertionSort']['runtime_ns'] >= 9700) or (time_and_memory['insertionSort']['runtime_ns'] <= 686300))
    return all(results)
...
where sortedness(<start>) >= 0.6470588235294118
