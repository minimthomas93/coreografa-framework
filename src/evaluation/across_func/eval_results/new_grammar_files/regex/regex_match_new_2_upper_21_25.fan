...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 6689100 or time_and_memory['regex_match']['runtime_ns'] <= 25443400 or time_and_memory['re_match']['runtime_ns'] >= 6689100 or (time_and_memory['re_match']['runtime_ns'] <= 25443400))
    return all(results)
