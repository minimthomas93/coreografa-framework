...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['memory_peak'] >= 1005226 or time_and_memory['regex_match']['memory_peak'] <= 1256152 or time_and_memory['re_match']['memory_peak'] >= 1005226 or (time_and_memory['re_match']['memory_peak'] <= 1256152))
    return all(results)
