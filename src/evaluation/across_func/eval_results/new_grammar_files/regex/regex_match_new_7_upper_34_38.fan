...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['memory_peak'] >= 4269 or time_and_memory['regex_match']['memory_peak'] <= 833879 or time_and_memory['re_match']['memory_peak'] >= 4269 or (time_and_memory['re_match']['memory_peak'] <= 833879))
    return all(results)
