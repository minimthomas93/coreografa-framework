...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 3363300 or time_and_memory['regex_match']['runtime_ns'] <= 15740900 or time_and_memory['re_match']['runtime_ns'] >= 3363300 or (time_and_memory['re_match']['runtime_ns'] <= 15740900))
    return all(results)
