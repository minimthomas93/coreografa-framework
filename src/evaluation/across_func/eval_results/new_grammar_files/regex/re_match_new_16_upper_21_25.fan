...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 1729100 or time_and_memory['regex_match']['runtime_ns'] <= 30145000 or time_and_memory['re_match']['runtime_ns'] >= 1729100 or (time_and_memory['re_match']['runtime_ns'] <= 30145000))
    return all(results)
