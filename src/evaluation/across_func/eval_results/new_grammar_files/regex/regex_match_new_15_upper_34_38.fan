...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 2124300 or time_and_memory['regex_match']['runtime_ns'] <= 117590200 or time_and_memory['re_match']['runtime_ns'] >= 2124300 or (time_and_memory['re_match']['runtime_ns'] <= 117590200))
    return all(results)
