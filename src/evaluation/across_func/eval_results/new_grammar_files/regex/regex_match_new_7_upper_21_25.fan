...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 3908800 or time_and_memory['regex_match']['runtime_ns'] <= 162187900 or time_and_memory['re_match']['runtime_ns'] >= 3908800 or (time_and_memory['re_match']['runtime_ns'] <= 162187900))
    return all(results)
