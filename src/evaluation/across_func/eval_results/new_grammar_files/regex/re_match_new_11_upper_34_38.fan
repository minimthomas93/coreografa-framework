...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 6523700 or time_and_memory['regex_match']['runtime_ns'] <= 13756300 or time_and_memory['re_match']['runtime_ns'] >= 6523700 or (time_and_memory['re_match']['runtime_ns'] <= 13756300))
    return all(results)
