...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 20774780 or time_and_memory['regex_match']['runtime_ns'] <= 23067800 or time_and_memory['re_match']['runtime_ns'] >= 20774780 or (time_and_memory['re_match']['runtime_ns'] <= 23067800))
    return all(results)
...
where count_pattern_tokens(<start>) <= 24.0
