...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 137600 or time_and_memory['regex_match']['runtime_ns'] <= 6296100 or time_and_memory['re_match']['runtime_ns'] >= 137600 or (time_and_memory['re_match']['runtime_ns'] <= 6296100))
    return all(results)
