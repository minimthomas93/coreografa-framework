...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 104480220 or time_and_memory['regex_match']['runtime_ns'] <= 139195460 or time_and_memory['re_match']['runtime_ns'] >= 104480220 or (time_and_memory['re_match']['runtime_ns'] <= 139195460))
    return all(results)
...
where count_pattern_tokens(<start>) >= 21.0
where count_pattern_tokens(<start>) <= 31.0
