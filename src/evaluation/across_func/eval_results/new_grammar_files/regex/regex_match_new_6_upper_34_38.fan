...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 4020700 or time_and_memory['regex_match']['runtime_ns'] <= 3833827600 or time_and_memory['re_match']['runtime_ns'] >= 4020700 or (time_and_memory['re_match']['runtime_ns'] <= 3833827600))
    return all(results)
