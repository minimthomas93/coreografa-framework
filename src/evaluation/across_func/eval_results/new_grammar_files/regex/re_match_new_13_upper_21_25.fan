...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['memory_peak'] >= 1966 or time_and_memory['regex_match']['memory_peak'] <= 13141 or time_and_memory['re_match']['memory_peak'] >= 1966 or (time_and_memory['re_match']['memory_peak'] <= 13141))
    return all(results)
