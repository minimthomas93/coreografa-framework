...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['memory_peak'] >= 3601 or time_and_memory['regex_match']['memory_peak'] <= 15324 or time_and_memory['re_match']['memory_peak'] >= 3601 or (time_and_memory['re_match']['memory_peak'] <= 15324))
    return all(results)
