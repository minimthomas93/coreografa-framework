...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['memory_peak'] >= 2259858 or time_and_memory['regex_match']['memory_peak'] <= 2510785 or time_and_memory['re_match']['memory_peak'] >= 2259858 or (time_and_memory['re_match']['memory_peak'] <= 2510785))
    return all(results)
