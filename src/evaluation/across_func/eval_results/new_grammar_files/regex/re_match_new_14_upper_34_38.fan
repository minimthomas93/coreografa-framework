...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 1818900 or time_and_memory['regex_match']['runtime_ns'] <= 119302300 or time_and_memory['re_match']['runtime_ns'] >= 1818900 or (time_and_memory['re_match']['runtime_ns'] <= 119302300))
    return all(results)
