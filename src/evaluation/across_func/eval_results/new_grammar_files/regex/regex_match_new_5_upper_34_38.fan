...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['memory_peak'] >= 3932 or time_and_memory['regex_match']['memory_peak'] <= 30636255 or time_and_memory['re_match']['memory_peak'] >= 3932 or (time_and_memory['re_match']['memory_peak'] <= 30636255))
    return all(results)
