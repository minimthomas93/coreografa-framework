...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['regex_match']['runtime_ns'] >= 2076500 or time_and_memory['regex_match']['runtime_ns'] <= 29555100 or time_and_memory['re_match']['runtime_ns'] >= 2076500 or (time_and_memory['re_match']['runtime_ns'] <= 29555100))
    return all(results)
