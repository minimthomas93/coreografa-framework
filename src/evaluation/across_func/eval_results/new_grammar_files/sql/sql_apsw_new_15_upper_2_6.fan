...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 648300 or time_and_memory['sql_apsw']['runtime_ns'] <= 7635300 or time_and_memory['sql_sqlite']['runtime_ns'] >= 648300 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 7635300))
    return all(results)
