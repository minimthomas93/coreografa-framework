...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 1071000 or time_and_memory['sql_apsw']['runtime_ns'] <= 3917200 or time_and_memory['sql_sqlite']['runtime_ns'] >= 1071000 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 3917200))
    return all(results)
