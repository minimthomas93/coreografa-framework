...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 16131810 or time_and_memory['sql_apsw']['runtime_ns'] <= 31239920 or time_and_memory['sql_sqlite']['runtime_ns'] >= 16131810 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 31239920))
    return all(results)
