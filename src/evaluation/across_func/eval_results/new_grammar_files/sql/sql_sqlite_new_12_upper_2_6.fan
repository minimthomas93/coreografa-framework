...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 1287900 or time_and_memory['sql_apsw']['runtime_ns'] <= 8379500 or time_and_memory['sql_sqlite']['runtime_ns'] >= 1287900 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 8379500))
    return all(results)
