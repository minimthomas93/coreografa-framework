...
<column_list> ::= (<column_name> {54,58} | <column_name> ',' <column_list>)
...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 1412600 or time_and_memory['sql_apsw']['runtime_ns'] <= 121136200 or time_and_memory['sql_sqlite']['runtime_ns'] >= 1412600 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 121136200))
    return all(results)
