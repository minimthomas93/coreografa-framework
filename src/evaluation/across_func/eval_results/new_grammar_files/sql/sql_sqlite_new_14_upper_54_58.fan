...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 3060100 or time_and_memory['sql_apsw']['runtime_ns'] <= 10040400 or time_and_memory['sql_sqlite']['runtime_ns'] >= 3060100 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 10040400))
    return all(results)
