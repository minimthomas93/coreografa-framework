...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 3004900 or time_and_memory['sql_apsw']['runtime_ns'] <= 15138900 or time_and_memory['sql_sqlite']['runtime_ns'] >= 3004900 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 15138900))
    return all(results)
