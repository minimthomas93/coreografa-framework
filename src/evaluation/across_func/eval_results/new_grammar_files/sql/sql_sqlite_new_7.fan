...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 1330100 or time_and_memory['sql_apsw']['runtime_ns'] <= 8098200 or time_and_memory['sql_sqlite']['runtime_ns'] >= 1330100 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 8098200))
    return all(results)
