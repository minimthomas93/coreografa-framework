...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 2895700 or time_and_memory['sql_apsw']['runtime_ns'] <= 15223800 or time_and_memory['sql_sqlite']['runtime_ns'] >= 2895700 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 15223800))
    return all(results)
