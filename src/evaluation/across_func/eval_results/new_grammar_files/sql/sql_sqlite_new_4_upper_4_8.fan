...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 1414700 or time_and_memory['sql_apsw']['runtime_ns'] <= 7227600 or time_and_memory['sql_sqlite']['runtime_ns'] >= 1414700 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 7227600))
    return all(results)
