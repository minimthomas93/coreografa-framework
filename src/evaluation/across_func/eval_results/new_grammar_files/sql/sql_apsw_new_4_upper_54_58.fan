...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['runtime_ns'] >= 4015700 or time_and_memory['sql_apsw']['runtime_ns'] <= 11698100 or time_and_memory['sql_sqlite']['runtime_ns'] >= 4015700 or (time_and_memory['sql_sqlite']['runtime_ns'] <= 11698100))
    return all(results)
