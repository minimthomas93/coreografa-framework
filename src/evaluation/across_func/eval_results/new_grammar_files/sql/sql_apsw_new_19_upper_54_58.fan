...
def constraints(tree):
    ...
    for func_name in user_system_funcs:
        ...
        results.append(time_and_memory['sql_apsw']['memory_peak'] >= 4451 or time_and_memory['sql_apsw']['memory_peak'] <= 6327 or time_and_memory['sql_sqlite']['memory_peak'] >= 4451 or (time_and_memory['sql_sqlite']['memory_peak'] <= 6327))
    return all(results)
